          ...
          <div className="mx-auto md:px-8 px-4 text-center relative overflow-hidden md:py-12 py-6">
            <div className="relative z-10 md:max-w-[85%] lg:max-w-[65%] mx-auto">
              ...
              <Button
                ...
                type="button"
                className="bg-[var(--color-primary)] text-white px-8 py-3.5 rounded-full cursor-pointer transition-colors text-lg md:w-auto w-full hover:bg-[var(--color-gray2)]/65"
              />
            </div>
          </div>
        </section>
